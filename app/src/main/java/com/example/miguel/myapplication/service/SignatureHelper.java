...
public final class SignatureHelper {
     ...
     * @param requestUrl          The URL where the data was sent to or received from
     * @param baseParameterString The sorted base parameter string containing the OAuth
     ...
     *
     * @param baseSignatureString The URL encoded base signature string with method, URL, OAuth
     *                            parameters and function parameters (e.g.
     *                            'date_since=0&max=10')
     * @param consumerSecret      The application secret
     * @param tokenSecret         The access secret
     ...
     * the server.
     * @throws Exception if there was an error calculating the signature (e.g. missing
     *                   internal methods).
     */
     ...
     *
     * @param authorization The complete authorization header string
     * @return A map with name/value pairs of the individual OAuth parameters
     * @throws Exception if there was a problem with one of the parameters or the
