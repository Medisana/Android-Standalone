...
import com.example.miguel.myapplication.service.SignatureHelper;
...
public final class MapUtil {
     ...
     * and signature map.
     *
     * @param signatureMap    The elements of the authorization header in a map
     * @param parameterString The given parameter string of the access
