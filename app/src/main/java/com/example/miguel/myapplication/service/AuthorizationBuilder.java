package com.example.miguel.myapplication.service;

import com.example.miguel.myapplication.util.ConstantsStorage;
import com.example.miguel.myapplication.util.MapUtil;
...
public final class AuthorizationBuilder {
    ...
    private static final String[] MODULE_NAME = { "cardiodocks",
            ...
            "", "", "", "", "", "tracker/phase", "tracker/stats","oxymeters", "oxymeters/settings","rt_pulse"  };
     ...
     *
     * @param applicationToken  Token of the requesting Application
     * @param applicationSecret Secret of the requesting Application
     ...
     *
     * @param applicationToken         Token of the Consumer's application
     * @param applicationSecret        Secret of the Consumer's application
     * @param unauthorizedAccessToken  Valid Unauthorized Access Token received earlier from the
     *                                 server
     * @param unauthorizedAccessSecret Unauthorized Secret received earlier from the server
     * @param verifierToken            Verifier Token received from a callback from the server
     * @return The Authorization header as a string
     * @throws Exception
     */
    public static String createAccessRequestAuthorizationHeader(
        ...
        String requestUrl = ConstantsStorage.HTTPS_AUTH_URL + "/accesses/verify";
     ...
     * server.
     *
     * @param moduleId                The id of the module to access
     * @param parameterString         The encoded parameter string
     * @param applicationToken        Token of the Consumer's application
     * @param applicationSecret       Secret of the Consumer's application
     * @param unauthorizedAccessToken Unauthorized Secret received earlier from the server
     * @param accessToken             Access Token received earlier from the server
     * @param accessSecret            Access Secret received earlier from the server
     * @throws Exception
     * @throws UnsupportedEncodingException if there was an error encoding the URL
     */
     ...
     * the server.
     *
     * @param moduleId          id of the module to load data from
     * @param start             first entry of entry returned
     * @param max               maximum number of entries returned
     * @param dateSince         retrieve all entries with a measurement date later than this
     * @param applicationToken  Token of the Consumer's application
     * @param applicationSecret Secret of the Consumer's application
     * @param accessToken       Access Token received earlier from the server
     * @param accessSecret      Access Secret received earlier from the server
    ...
    public static String createRequestUrl(final int moduleId) {
        return ConstantsStorage.HTTPS_DATA_URL + "/" + MODULE_NAME[moduleId];
    }
